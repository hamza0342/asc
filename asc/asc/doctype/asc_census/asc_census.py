...
class ASC(Document):
    ...
    def add_items(self):
        ...
        self.total_utilized = self.learning_teacher_material + self.m_repair + self.covid_essential_items
        self.total_disable_students = self.polio_affected + self.physical_disabilites
        self.total_surrounding_schools = self.no_of_private_schools + self.no_of_sef_schools
        pass
