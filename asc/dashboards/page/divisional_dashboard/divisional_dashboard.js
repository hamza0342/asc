frappe.pages['divisional-dashboard'].on_page_load = function (wrapper) {
	...
	add: function (page) {
		...
		let fiterbtn = page.add_field({
			...
			click() {
				...
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.get_data",
					args: {
				...
				// start of enrollment
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.get_enrollment",
					args: {
						district: district.get_value(),
						year: year.get_value(),
					},
				...
				// start of facility
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.get_facility",
					args: {
						district: district.get_value(),
						year: year.get_value(),
					},
				...
				// start of staff
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.get_staff",
					args: {
						district: district.get_value(),
						year: year.get_value(),
					},
				...
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.year_based_status",
					args: {
						district: district.get_value(),
						year: year.get_value(),
					},
				...
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.enrollment_ratio",
					args: {
						district: district.get_value(),
						year: year.get_value(),
					},
				...
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.taluka_data",
					args: {
						district: district.get_value(),
						year: year.get_value(),
					},
					callback: function (r) {
						...
						$('#taluka_data').empty();
						$(
							frappe.render_template("taluka_data", r.message[0])
				...
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.taluka_facility",
					args: {
						district: district.get_value(),
						year: year.get_value(),
					},
					callback: function (r) {
						...
						$(
							frappe.render_template("taluka_facility", r.message)
				...
				frappe.call({
					method: "asc.dashboards.page.divisional_dashboard.divisional_dashboard.line_graph_data",
					args: {
						district: district.get_value(),
						year: year.get_value(),
					},
