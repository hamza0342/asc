frappe.pages['school-page'].on_page_load = function (wrapper) {
	...
	add: function (page) {
		...
		let fiterbtn = page.add_field({
			...
			click() {
				...
				// $('#school_profile').remove();
				// frappe.call({
				// 	method: "asc.dashboards.page.school_page.school_page.get_data",
				// 	args: {
				...
				// 		} else {
				// 			$(
				// 				frappe.render_template("school_page", { 'response': r.message })
				// 			).appendTo(page.main);
				// 		}
				// 	},
				// });
...
async function server_call(page, school_, year_) {
	...
	//call for basic data
	await frappe.call({
		method: "asc.dashboards.page.school_page.school_page.basic_data",
		args: {
			school: school_,
			year: year_,
		},
	...
	frappe.call({
		method: "asc.dashboards.page.school_page.school_page.visit_section",
		args: {
			school: school_,
			year: year_,
		},
	...
	frappe.call({
		method: "asc.dashboards.page.school_page.school_page.building_data",
		args: {
			school: school_,
			year: year_,
		},
	...
	//call for staff
	frappe.call({
		method: "asc.dashboards.page.school_page.school_page.staff_data",
		args: {
			school: school_,
			year: year_,
		},
	...
	frappe.call({
		method: "asc.dashboards.page.school_page.school_page.facility_data",
		args: {
			school: school_,
			year: year_,
		},
	...
	//call for item_data
	frappe.call({
		method: "asc.dashboards.page.school_page.school_page.item_data",
		args: {
			school: school_,
			year: year_,
		},
	...
	//call for enrollment
	frappe.call({
		method: "asc.dashboards.page.school_page.school_page.enrollment_data",
		args: {
			school: school_,
			year: year_,
		},
	...
	if (sec_flag || hi_sec_flag) {
		...
		frappe.call({
			method: "asc.dashboards.page.school_page.school_page.secondary_data",
			args: {
				school: school_,
				year: year_,
			},
	...
	if (hi_sec_flag) {
		...
		frappe.call({
			method: "asc.dashboards.page.school_page.school_page.hi_secondary_data",
			args: {
				school: school_,
				year: year_,
			},
	...
	frappe.call({
		method: "asc.dashboards.page.school_page.school_page.smc_section",
		args: {
			school: school_,
			year: year_,
		},
