frappe.pages['provincial-dashboard'].on_page_load = async function (wrapper) {
  ...
  $(frappe.render_template("provisional_skeleton")).appendTo(page.main);


  frappe.call({
    method: "asc.dashboards.page.provincial_dashboard.provincial_dashboard.get_role",
    args: {
      year: "2021-22",
    },
    callback: function (r) {
  ...
  await frappe.call({
    method: "asc.dashboards.page.provincial_dashboard.provincial_dashboard.get_data",
    args: {
      year: "2021-22",
    },
    callback: function (r) {
  ...
  frappe.call({
    method: "asc.dashboards.page.provincial_dashboard.provincial_dashboard.get_chart_data",
    args: {
      year: "2021-22",
    },
    callback: function (r) {
