...
frappe.query_reports["Test Indicators Trend Analysis"] = {
	"filters": [
		{
			fieldname: "",
...
function open_report(Test,Year,level,s_status,s_gender,ele_con,water,buil_cond,s_loc,b_avail,Division,district) {

	// if (Year && region) {
	// 	console.log("here")
	// 	frappe.set_route("query-report", "School List Export", { "Division": region,"Year": Year });
	// }
	if (Test && Year ){
		console.log("in Function")
		frappe.set_route("school-page", { "year": Year ,"level":level,"status":s_status,"school_gender":s_gender,"electricity_connection": ele_con,"water_available":water,"condition_of_building":buil_cond,"location":s_loc,"building_availability":b_avail,"division":Division,"district":district});
	}

	// if(region && year && Test && district){
	// 	console.log(district)
	// 	frappe.set_route("query-report","School List Export",{"District": district,"Division": region,"Year": Year})
	// }
}